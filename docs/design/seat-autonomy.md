...
section = "15"
depends = ["i"]
write-set = ["crates/xtask/src/genmanifest.rs", "hooks/hooks.json", "crates/scribe2/src/hook/", "crates/scribe2/tests/e2e/hook.rs"]
