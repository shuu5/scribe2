...
verify = ["cargo nextest run -p scribe2-boundary --test e2e --no-tests=fail pipe_dispatch_group_model_gate_", "cargo nextest run -p scribe2-boundary --test e2e --no-tests=fail seat_tick_judge_model_gate_", "cargo nextest run -p scribe2-boundary --test e2e --no-tests=fail seat_tick_account_gate_model_", "cargo nextest run -p scribe2-boundary --test e2e --no-tests=fail host_group_next_model_gate_", "cargo nextest run -p scribe2-boundary --test e2e --no-tests=fail hook_group_model_gate_", "cargo nextest run -p scribe2-boundary --test e2e --no-tests=fail hook_group_model_window_alone_prints_the_model_window", "cargo nextest run -p scribe2 --lib --no-tests=fail hook_group_pressed_"]
size = "M"
