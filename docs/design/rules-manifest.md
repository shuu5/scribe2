...
| `gate.token_cap` | GateTokenCap | 1000000 | true | user 2026-09-14（一時・戻し = s2-07l.267）・純移動の分割便（s2-07l.261 / .264）を lens の門に通すため 150000（grill U3 / 2026-09-07）から一時的に上げる・SRS NFR1（目標値＝本裁定はその目標を一時的に超える） |
