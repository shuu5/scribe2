...
req = ["FR7", "FR17", "NFR3"]
section = "4"
write-set = ["+crates/xtask/src/deps_delta.rs", "crates/xtask/src/main.rs", "crates/xtask/src/limits.rs", "crates/xtask/src/check_facts.rs", ".github/workflows/ci.yml", "docs/design/rules-manifest.md"]
